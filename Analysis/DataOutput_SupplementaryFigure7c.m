  % Mission 1 : Data Output of Supplementary Figure 7c
    ...
    SourceDataPLUSPLUS={} ; SourceDataPLUSPLUS{1,3}='Volume Ratio Between Sister Cells (Averaged)'           ; SourceDataPLUSPLUS{1,1}='Cell 1'   ; SourceDataPLUSPLUS{1,2}='Cell 2' ;
    SourceDataPLUSPLUS{1,4}='Variation Coefficient of Volume Ratio Between Sister Cells'       ;
...
for iii=1:length(VAR)
    ...
    xlswrite('Supplementary Figure 7c.xls',SourceDataPLUSPLUS,'Figure S7c')  ;