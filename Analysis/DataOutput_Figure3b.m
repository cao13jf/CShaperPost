  % Mission 1 : Data Output of Figure 3b
    ...
    load('E:\Project 1 - C.elegans Resource\11-Patch\Problem 1 - WT Cycle\WorkSpace_CellName') ; SourceData{1,1}='Cell/Nucleus Position ([x,y,z]/¦Ìm)'  ;
    SourceData{2,1}='Cell Name'   ;
for k1=1:size(C,1)
for k2=1:size(C,2)
...
for N=1:size(EMBRYO,1)+length(HLH1)
    ...
    if  length(Sequence0{18,1}{1,N}{k0,1}{k1,k2})==3 && strcmp(CELLNAME{j,1},CellName{k0,1}{k1,k2})==1
        ...
        hold on ; axis equal ; X=sprintf('%2.2f',Sequence0{18,1}{1,N}{k0,1}{k1,k2}(2)) ; Y=sprintf('%2.2f',Sequence0{18,1}{1,N}{k0,1}{k1,k2}(3)) ; Z=sprintf('%2.2f',Sequence0{18,1}{1,N}{k0,1}{k1,k2}(1)) ;
        SourceData{2+j,1+N}=['[',X,',',Y,',',Z,']'] ;
    end
    end
    end
    end
    ...
    xlswrite('Figure 3b.xls',SourceData,'Figure 3b')            ;