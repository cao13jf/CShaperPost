  % Mission 1 : Data Analysis of Figure 3c
    ...
    load('E:\Project 12 - Wnt & Membrane\CJF\Paper Revision - PLUSPLUS\Revision20200423 - StandardDataset_CONTACT\WorkSpace_Contact8Cell_TEST') ;
...
if  isnumeric(CellName{k0,1}{k1,k2})==0 && strcmp(CellName{k0,1}{k1,k2},CELLNAME{j,1})==1
    ...
    set(gca,'FontSize',20,'Fontname','arial') ; h=findobj(gca) ; view(-40,20)    ; camlight ;    
